...
# более-менее норм, но много шума

# Load mesh and texture into PyVista
absolute_path = os.path.dirname(__file__)
mesh_path = os.path.join(absolute_path, "mesh", 'sagrada-familia-complete.STL')
...
pl.subplot(0, 1)
voxels = pv.voxelize(mesh, density=0.2, check_surface=False)
